-- This script was provided by the course to prepare the environment for Module 3.
-- It contains the schema definitions for tables in the staging data warehouse.
